...
void NN::FNN_BACKWARD_PROPAGATE_FEEDFORWARD_LAYER ()
{
	int fn1,fn2;
...
//	 std::cout<<"BP"<<mNNdboutputlayererror[fn1]<<std::endl;
 	...
 	mNNdboutputlayererror[fn1] = (2*mNNdboutputlayererror[fn1])/mNNndatasize;
...
//propagate error from 10th layer to 9th layer	
	if (mNNnlayerbreadth>=9) {
	 ...
	 else { FNN_BACKWARD_MULTIPLY_LAYER_11_10 (); }
...
//propagate error from 9th layer to 8th layer	
	if (mNNnlayerbreadth>=8) {
	 ...
	 else { FNN_BACKWARD_MULTIPLY_LAYER_10_9 (); }
...
//propagate error from 8th layer to 7th layer	
	if (mNNnlayerbreadth>=7) {
	 ...
	 else { FNN_BACKWARD_MULTIPLY_LAYER_9_8 (); }
...
//propagate error from 7th layer to 6th layer	
	if (mNNnlayerbreadth>=6) {
	 ...
	 else { FNN_BACKWARD_MULTIPLY_LAYER_8_7 (); }
...
//propagate error from 6th layer to 5th layer	
	if (mNNnlayerbreadth>=5) {
	 ...
	 else { FNN_BACKWARD_MULTIPLY_LAYER_7_6 (); }
...
//propagate error from 5th layer to 4th layer	
	if (mNNnlayerbreadth>=4) {
	 ...
	 else { FNN_BACKWARD_MULTIPLY_LAYER_6_5 (); }
...
//propagate error from 4th layer to 3rd layer	
	if (mNNnlayerbreadth>=3) {
	 ...
	 else { FNN_BACKWARD_MULTIPLY_LAYER_5_4 (); }
...
//propagate error from 3rd layer to 2rd layer	
	if (mNNnlayerbreadth>=2) {
	 ...
	 else { FNN_BACKWARD_MULTIPLY_LAYER_4_3 (); }
...
//propagate error from 2nd layer to 1st layer	
	if (mNNnlayerbreadth>=1) {
	 ...
	 else { FNN_BACKWARD_MULTIPLY_LAYER_3_2 (); }
...
//propagate error from 2nd layer to 1st layer	
	if (mNNnlayerbreadth>=0) {
	 ...
	 else { FNN_BACKWARD_MULTIPLY_LAYER_2_1 (); }
...
void NN::FNN_BACKWARD_MULTIPLY_LAYER_11_10 () {
	int fn1,fn2;
	double fdbhold;
	 ...
	 for (fn1=0; fn1<mNNn10thlayerlength; fn1++) {
      fdbhold = 0.000;
	   for (fn2=0; fn2<mNNn11thlayerlength; fn2++) {
		  fdbhold +=
		 (mNNdbB11error[fn2] * mNNdbW1011[fn2][fn1]);
			 }
...
void NN::FNN_BACKWARD_MULTIPLY_LAYER_10_9 () {
	int fn1,fn2;
	double fdbhold;
     ...
     for (fn1=0; fn1<mNNn9thlayerlength; fn1++) {
      fdbhold = 0.000;
	   for (fn2=0; fn2<mNNn10thlayerlength; fn2++) {
		  fdbhold +=
		 (mNNdbB10error[fn2] * mNNdbW910[fn2][fn1]);
			 }
...
void NN::FNN_BACKWARD_MULTIPLY_LAYER_9_8 () {
	int fn1,fn2;
	double fdbhold;
     ...
     for (fn1=0; fn1<mNNn8thlayerlength; fn1++) {
      fdbhold = 0.000;
	   for (fn2=0; fn2<mNNn9thlayerlength; fn2++) {
		  fdbhold +=
		 (mNNdbB9error[fn2] * mNNdbW89[fn2][fn1]);
			 }
...
void NN::FNN_BACKWARD_MULTIPLY_LAYER_8_7 () {
	int fn1,fn2;
	double fdbhold;
     ...
     for (fn1=0; fn1<mNNn7thlayerlength; fn1++) {
      fdbhold = 0.000;
	   for (fn2=0; fn2<mNNn8thlayerlength; fn2++) {
		  fdbhold +=
		 (mNNdbB8error[fn2] * mNNdbW89[fn2][fn1]);
			 }
			mNNdb9thlayererror[fn1] = fdbhold;
	 }
} 
...
void NN::FNN_BACKWARD_MULTIPLY_LAYER_7_6 () {
	int fn1,fn2;
	double fdbhold;
     ...
     for (fn1=0; fn1<mNNn6thlayerlength; fn1++) {
      fdbhold = 0.000;
	   for (fn2=0; fn2<mNNn7thlayerlength; fn2++) {
		  fdbhold +=
		 (mNNdbB7error[fn2] * mNNdbW67[fn2][fn1]);
			 }
...
void NN::FNN_BACKWARD_MULTIPLY_LAYER_6_5 () {
	int fn1,fn2;
	double fdbhold;
     ...
     for (fn1=0; fn1<mNNn5thlayerlength; fn1++) {
      fdbhold = 0.000;
	   for (fn2=0; fn2<mNNn6thlayerlength; fn2++) {
		  fdbhold +=
		 (mNNdbB6error[fn2] * mNNdbW56[fn2][fn1]);
			 }
...
void NN::FNN_BACKWARD_MULTIPLY_LAYER_5_4 () {
	int fn1,fn2;
	double fdbhold;
     ...
     for (fn1=0; fn1<mNNn4thlayerlength; fn1++) {
      fdbhold = 0.000;
	   for (fn2=0; fn2<mNNn5thlayerlength; fn2++) {
		  fdbhold +=
		 (mNNdbB5error[fn2] * mNNdbW45[fn2][fn1]);
			 }
...
void NN::FNN_BACKWARD_MULTIPLY_LAYER_4_3 () {
	int fn1,fn2;
	double fdbhold;
     ...
     for (fn1=0; fn1<mNNn3rdlayerlength; fn1++) {
      fdbhold = 0.000;
	   for (fn2=0; fn2<mNNn4thlayerlength; fn2++) {
		  fdbhold +=
		 (mNNdbB4error[fn2] * mNNdbW34[fn2][fn1]);
			 }
...
void NN::FNN_BACKWARD_MULTIPLY_LAYER_3_2 () {
	int fn1,fn2;
	double fdbhold;
     ...
     for (fn1=0; fn1<mNNn2ndlayerlength; fn1++) {
      fdbhold = 0.000;
	   for (fn2=0; fn2<mNNn3rdlayerlength; fn2++) {
		  fdbhold +=
		 (mNNdbB3error[fn2] * mNNdbW23[fn2][fn1]);
			 }
...
void NN::FNN_BACKWARD_MULTIPLY_LAYER_2_1 () {
	int fn1,fn2;
	double fdbhold;
     ...
     for (fn1=0; fn1<mNNn1stlayerlength; fn1++) {
      fdbhold = 0.000;
	   for (fn2=0; fn2<mNNn2ndlayerlength; fn2++) {
		  fdbhold +=
		 (mNNdbB2error[fn2] * mNNdbW12[fn2][fn1]);
			 }
...
void NN::FNN_BACKWARD_MULTIPLY_LAYER_1_0 () {
	int fn1,fn2;
	double fdbhold;
     ...
     for (fn1=0; fn1<mNNninputlayerlength; fn1++) {
      fdbhold = 0.000;
	   for (fn2=0; fn2<mNNn1stlayerlength; fn2++) {
		  fdbhold +=
		 (mNNdbB1error[fn2] * mNNdbW01[fn2][fn1]);
			 }
